...
import torch
import torchvision
from local_utilities import LightningModel, ImageNetDataModule, plot_csv_logger, get_model_list
...
def train_model(resnet_type, augmentation):
    ...
    dm = ImageNetDataModule(height_width=(224, 224), batch_size=64, num_workers=4, augment_data=augment_data)
